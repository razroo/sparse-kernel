...
import { loadSessionStoreFromRuntimeLedger } from "./runtime-ledger.js";
import {
...
export function loadSessionStore(
  ...
  if (!opts.skipRuntimeLedger) {
    const runtimeStore = loadSessionStoreFromRuntimeLedger(storePath);
    if (runtimeStore) {
      normalizeSessionStore(runtimeStore);
      return opts.clone === false ? runtimeStore : structuredClone(runtimeStore);
    }
  }
