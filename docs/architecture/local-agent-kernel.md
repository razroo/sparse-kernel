...
- Native browser process pooling exists for loopback CDP contexts, but it is still a small supervisor around Chromium. It is not a full Playwright-equivalent process manager and does not provide host isolation.
