...
VALUES ('architecture', 'SparseKernel', datetime('now'));
...
VALUES
  ('public_web', 'Unauthenticated public web access. Browser route blocking is not a hard security boundary.', 'browser_context', 'public_web_default', '{"mode":"none"}', NULL, NULL, NULL, datetime('now')),
  ...
  ('code_execution', 'Code execution requiring explicit backend isolation semantics.', 'local/no_isolation', 'code_execution_default', '{"mode":"workspace"}', NULL, NULL, NULL, datetime('now')),
  ...
  ('user_browser_profile', 'User browser profile access requiring explicit user trust.', 'browser_context', 'authenticated_web_default', '{"mode":"none"}', NULL, NULL, NULL, datetime('now'));
